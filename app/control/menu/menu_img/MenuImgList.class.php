 ...
 */
class MenuImgList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_MenuImg');
        $this->form->setFormTitle('Adicone novos icones ao menu');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['MenuImgForm', 'onEdit']), 'fa:plus green');
        ...
        $column_directory = new TDataGridColumn('directory', 'Icone', 'left');
        $column_created_at = new TDataGridColumn('created_at', 'Criado em', 'left');
        $column_updated_at = new TDataGridColumn('updated_at', 'Editado em', 'left');
        ...
        $action1 = new TDataGridAction(['MenuImgForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for MenuImg
            $repository = new TRepository('MenuImg');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('app'); // open a transaction with database
            $object = new MenuImg($key, FALSE); // instantiates the Active Record
