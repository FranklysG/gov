...
class MenuList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['MenuForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['MenuForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Menu
            $repository = new TRepository('Menu');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('app'); // open a transaction with database
            $object = new Menu($key, FALSE); // instantiates the Active Record
