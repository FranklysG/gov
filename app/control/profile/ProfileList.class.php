 ...
 */
class ProfileList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Profile');
        $this->form->setFormTitle('Profile');
        ...
        $column_system_user_id = new TDataGridColumn('system_user_id->profiles->name', 'Login', '');
    ...
    public function onInlineEdit($param)
    {
        try
        {
            ...
            $object = new Profile($key); // instantiates the Active Record
            $object->{$field} = $value;
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('app'); // open a transaction with database
            $object = new Profile($key, FALSE); // instantiates the Active Record
